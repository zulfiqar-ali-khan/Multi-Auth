    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Admin Login
                    </a>

                    <a href="{{ route('customerlogin') }}"
                        class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Customer Login</a>
                @endauth
            </div>
        @endif
